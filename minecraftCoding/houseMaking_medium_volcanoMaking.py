...
for piramids in list(range(int(PIRAMIDS_SIZE / 2))):
    minecraftPy.setBlocks(blockX + piramids + 1, blockY, blockZ + piramids + 1,
                              blockX + PIRAMIDS_SIZE - piramids- 1, blockY + piramids- 1, blockZ + PIRAMIDS_SIZE - piramids- 1,
                              blocks.LAVA)
    time.sleep(2)